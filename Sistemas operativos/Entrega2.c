...
void ImprimirEjecutandose(WINDOW *IDventanaProcesos, struct PCB *PrimerNodo)
{
    ...
    if (primerNodo != NULL)
    {
        ...
        mvwprintw(IDventanaProcesos, 2, 2, "Programas diferentes cargados: %d",ProgramasCargados);
        mvwprintw(IDventanaProcesos, 3, 2, "Proceso en Ejecucion: ");
        mvwprintw(IDventanaProcesos, 4, 2, "PID: %d, FileName: %s, AX: %d, BX: %d, CX: %d, DX: %d, PC: %d, IR: %s", primerNodo->PID, primerNodo->fileName, primerNodo->AX, primerNodo->BX, primerNodo->CX, primerNodo->DX, primerNodo->PC, primerNodo->IR);
...
void ImprimirTerminados(WINDOW *IDventanaProcesos, struct PCB *PrimerNodo)
{
    ...
    if (NodoActual != NULL)
    {
        ...
        mvwprintw(IDventanaProcesos, 2, 2, "Programas diferentes cargados: %d",ProgramasCargados); // Título de la sección de procesos terminados
...
void ManejadorProcesos(WINDOW *IDventanaMensajes, struct PCB **Listos, struct PCB **Terminados, struct PCB **Ejecucion, int *SePuedeLeer, int *ProcesoCargado, int EjecucionComandos, char ArchivoCargadoValido[200], int EstadoProcesos)
{
  ...
  mvwprintw(IDventanaMensajes, 0, 2, "Programas cargados: %d", ProgramasCargados);
  wrefresh(IDventanaMensajes);
...
int main(void)
{
    ...
    box(IDventanaProcesos, 0, 0);
    mvwprintw(IDventanaProcesos, 0, 2, "LISTA DE PROCESOS");
    mvwprintw(IDventanaProcesos, 2, 2, "Programas diferentes cargados: ");
    mvwprintw(IDventanaProcesos, 4, 2, "Proceso en Ejecucion: ");
    mvwprintw(IDventanaProcesos, 5, 2, "...");
    mvwprintw(IDventanaProcesos, 10, 2, "Procesos en Espera: ");
    mvwprintw(IDventanaProcesos, 11, 2, "...");
    ...
    //sin tanto delay
      if (SePuedeLeer == 1 && ContadorLectura < 100)
      {
        ContadorLectura++;
      }
      else if (ContadorLectura >= 100)
      {
        LeerArchivoFlag = 1;
        ContadorLectura = 0;
      }
